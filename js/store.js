...
var projectName = ['Ay Eshi Sooq ' , 'Happiness Maker', 'GO LIVE Sport', 'Jobs Space', 'yumyum','Sagittarius','Yalla Tal3a','Annona',' Yars','Jordan Nature Reserves','Serious AAA','Commentat','Edusavior','Jobify','Trusty Hotels','RCC news','Animatic','Quiz Me','Trader','Anime','Moto Spare','Covid 19','Jo crafts','Dream House','Dev-Home'];
var projectsNameFinal = ['401 Python Project', '201 Project' , '201 Project', '301 Project','201 Project','301 Project','201 Project','301 Project ','201 Project', '201 Project','301 Project', '','401 JavaScript Project', '301 Project', '401 Python Project', '301 Project', '301 Project', '301 Project', '401 JavaScript Project', '301 Project', '201 Project', '301 Project', '201 Project', '201 Project', '301 Project'];
...
var projectLink=['https://code-blinders.github.io/Tal3a/']
...
for (var i = 0; i<projectName.length;i++){
  new ListItems (projectName[i],projectsNameFinal[i], projectLogo[i], projectLink[i]);
